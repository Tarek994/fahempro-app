...
enum NotificationTo {
  ...
  static String toText(NotificationTo notificationTo) {
    switch(notificationTo) {
      ...
      case NotificationTo.one: return Methods.getText(StringsManager.oneUser).toTitleCase();
    }
  }
}
...
enum WordStatusLabel {year, month, week, day, hour, minute, second, like, comment, lesson, student, point, product}
...
enum OrderByType {
  ...
  adminNotificationsNewestFirst(title: StringsManager.newestFirst, query: '${ApiConstants.adminNotificationIdField} ${ConstantsManager.desc}'),
  adminNotificationsOldestFirst(title: StringsManager.oldestFirst, query: '${ApiConstants.adminNotificationIdField} ${ConstantsManager.asc}'),
...
enum AdminPermissions {
  ...
  showNotifications(nameAr: 'عرض الاشعارات', nameEn: 'Show notifications'),
  sendNotifications(nameAr: 'ارسال اشعارات', nameEn: 'Send notifications'),

  showChats(nameAr: 'عرض المحادثات', nameEn: 'Show chats'),
