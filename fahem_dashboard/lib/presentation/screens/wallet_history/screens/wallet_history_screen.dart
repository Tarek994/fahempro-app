...
import 'package:fahem_dashboard/presentation/screens/wallet_history/widgets/wallet_history_list_item.dart';
    ...
    return Consumer<WalletHistoryProvider>(
      builder: (context, provider, _) {
        return TemplateListScreen(
          ...
          goToInsertScreen: provider.walletHistoryArgs != null ? null : Methods.checkAdminPermission(AdminPermissions.addWalletHistory) ? () {
            Methods.routeTo(context, Routes.insertEditWalletHistoryScreen, arguments: null, then: (walletHistory) => _onInsert(walletHistory));
          } : null,
          ...
          searchFilterOrderWidget: SearchFilterOrderWidget(
            ...
            filtersItems: provider.walletHistoryArgs == null
                ? const [FiltersType.dateOfCreated, FiltersType.userType, FiltersType.account, FiltersType.user, FiltersType.walletTransactionType]
                : const [FiltersType.dateOfCreated, FiltersType.walletTransactionType],
