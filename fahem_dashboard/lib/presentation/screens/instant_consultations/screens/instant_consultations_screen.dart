...
import 'package:fahem_dashboard/presentation/screens/instant_consultations/widgets/instant_consultation_list_item.dart';
    ...
    return Consumer<InstantConsultationsProvider>(
      builder: (context, provider, _) {
        return TemplateListScreen(
          ...
          goToInsertScreen: Methods.checkAdminPermission(AdminPermissions.addInstantConsultation) ? () {
            Methods.routeTo(context, Routes.insertEditInstantConsultationScreen, arguments: null, then: (instantConsultation) => _onInsert(instantConsultation));
          } : null,
          ...
          searchFilterOrderWidget: SearchFilterOrderWidget(
            ...
            filtersItems: const [FiltersType.dateOfCreated, FiltersType.user, FiltersType.account, FiltersType.isDone],
          ...
          listItemBuilder: (context, index) => InstantConsultationListItem(
            ...
            onDelete: () => _onDelete(provider.instantConsultations[index].instantConsultationId),
          ),
