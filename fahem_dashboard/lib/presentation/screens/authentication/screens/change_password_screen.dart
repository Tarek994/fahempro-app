                          ...
                          CustomButton(
                            onPressed: () {
                              ...
                              if(_formKey.currentState!.validate()) {
                                ChangeAdminPasswordParameters parameters = ChangeAdminPasswordParameters(
                                  adminId: MyProviders.authenticationProvider.currentAdmin.adminId,
                                  oldPassword: _textEditingControllerOldPassword.text,
                                  newPassword: _textEditingControllerNewPassword.text,
                                );
                                MyProviders.authenticationProvider.changePassword(context: context, changeAdminPasswordParameters: parameters);
                              }
                            },
