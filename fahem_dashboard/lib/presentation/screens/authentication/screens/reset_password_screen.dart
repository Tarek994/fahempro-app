                            ...
                            CustomButton(
                              onPressed: () {
                                ...
                                if(_formKey.currentState!.validate()) {
                                  ResetAdminPasswordParameters parameters = ResetAdminPasswordParameters(
                                    emailAddress: widget.emailAddress,
                                    password: _textEditingControllerPassword.text,
                                  );
                                  MyProviders.authenticationProvider.resetPassword(context: context, resetAdminPasswordParameters: parameters);
                                }
                              },
