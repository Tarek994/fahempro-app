    ...
    return Consumer<AboutAppProvider>(
      builder: (context, provider, _) {
        return TemplateItemScreen(
          ...
          goToEditScreen: Methods.checkAdminPermission(AdminPermissions.editAboutApp) ? () {
            Methods.routeTo(context, Routes.editAboutAppScreen, arguments: provider.aboutAppModel, then: (aboutApp) => _onEdit(aboutApp));
          } : null,
