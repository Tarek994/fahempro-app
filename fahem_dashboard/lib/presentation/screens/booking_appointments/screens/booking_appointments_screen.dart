...
import 'package:fahem_dashboard/presentation/screens/booking_appointments/widgets/booking_appointment_list_item.dart';
    ...
    return Consumer<BookingAppointmentsProvider>(
      builder: (context, provider, _) {
        return TemplateListScreen(
          ...
          goToInsertScreen: Methods.checkAdminPermission(AdminPermissions.addBookingAppointment) ? () {
            Methods.routeTo(context, Routes.insertEditBookingAppointmentScreen, arguments: null, then: (bookingAppointment) => _onInsert(bookingAppointment));
          } : null,
          title: _getTitle(),
