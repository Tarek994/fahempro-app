                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          // Email Address *
                          // if(widget.userModel == null || (widget.userModel != null && widget.userModel!.signInMethod == SignInMethod.emailAndPassword))
                            ...[
                            CustomTextFormField(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    CustomButton(
                                      ...
                                      textColor: provider.dialingCode == null ? ColorsManager.grey : ColorsManager.black,
                          ...
                          Stack(
                            ...
                            children: [
                              CustomButton(
                                ...
                                borderColor: ColorsManager.grey300,
                                iconColor: ColorsManager.grey,
                                textColor: provider.country == null ? ColorsManager.grey : ColorsManager.black,
                                fontSize: SizeManager.s12,
                                mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              if(_formKey.currentState!.validate() && insertEditUserProvider.isAllDataValid()) {
                                if(widget.userModel == null) {
                                  InsertUserParameters insertUserParameters = InsertUserParameters(
                                    ...
                                    password: _textEditingControllerPassword.text.trim().isEmpty ? null : _textEditingControllerPassword.text.trim(),
