...
class Routes {
  ...
  static const String insertEditNotificationScreen = '/insertEditNotificationScreen';
  // endregion
}
  ...
  return PageRouteBuilder(
    ...
    pageBuilder: (context, animation, secondaryAnimation) {
      ...
      // region Profile
        ...
        case Routes.editAccountProfileScreen: return MultiProvider(
          providers: [
            ChangeNotifierProvider(create: (_) => EditAccountProfileProvider()),
          ],
          child: EditAccountProfileScreen(accountModel: routeSettings.arguments),
        );
      // endregion
      ...
      // region Main
        case Routes.mainScreen: return MultiProvider(
          providers: [
            ChangeNotifierProvider(create: (_) => AccountStatisticsProvider()),
          ],
